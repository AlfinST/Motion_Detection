...
int main( int argc, char** argv )
{
  ...
  //namedWindow("Finally",cv::WINDOW_KEEPRATIO );
  //namedWindow("Finally2",cv::WINDOW_KEEPRATIO );
  ...
  for( int i = 0,area=0; i< contours.size(); i++,area=0 )
     {
       ...
       if(area >   ) //enter any number by default type 3000            ////////////////////////////////////////////////////////////////////////////////////MINIMUM_SIZE_OF_OBJECT_SET_HERE/////////////////////////////////////////////////////
       {
